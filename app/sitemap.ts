...
function baseSitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/brisket-paa-grillen", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/flanksteak-paa-grillen", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/spareribs-paa-grillen", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/kylling-paa-grillen", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/grillspyd", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/grillet-majs", priority: 0.8, changeFrequency: "monthly" as const },
